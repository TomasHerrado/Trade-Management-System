...
public class PurchaseController {
    ...
    @GetMapping
    public ResponseEntity<List<PurchaseResponse>> getByBranch(@PathVariable UUID branchId) {
    ...
    public ResponseEntity<List<PurchaseResponse>> getBySupplier(@PathVariable UUID supplierId) {
